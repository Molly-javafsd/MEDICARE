...
<br><form action="filterByCategory">
...
<tr><th>Medicine_ID</th><th>Name</th><th>Price</th><th>Category</th><th>Description</th><th>Offers</th><th>Status</th><th colspan="2">Action</th></tr>
...
<button type="submit" class="btn btn-danger">Delete <%=es.getMName()%></button>
</div>
</form>
<br>
<form action="editMed">
